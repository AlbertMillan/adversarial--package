...
class StepManager(Step):
    # TODO: Implement State Pattern (see notes)
    ...
    # def setStep(self, is_training, cfg):
    #     return step
    ...
    # def train_raw_step(self, x_batch, y_batch):
    #     self.currentStep(x_batch, y_batch)
    #     self.optimManager.step()
    #
    # def train_adv_step(self, x_batch, y_batch):
    #     x_adv = self.attack.run(x_batch, y_batch)
    #     self.currentStep(x_adv, y_batch)
    #     self.optimManager.step()
    #
    # def train_mix_step(self, x_batch, y_batch):
    #     self.train_raw_step(x_batch, y_batch)
    #     self.train_adv(x_batch, y_batch)
...
class MixedHGDStep(DefenseStep):
