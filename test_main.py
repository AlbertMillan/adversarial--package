...
from test_pipe import Pipeline
...
#     loss, accuracy = pipeline.run_defense(config.HYPERPARAMETERS.OPTIM)
    loss, accuracy = pipeline.run_defense_test(config.HYPERPARAMETERS.OPTIM)
